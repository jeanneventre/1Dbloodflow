...
def main(argv) :
    ...
    for pType in ["P"] :
        ...
        L1 = "0" ;
        PATH      = PATH2D + "K=" + Kstr + "/" + NNstr + "/Cv=" + Cvstr + "/Knl=" + L1 + "/dKst=" + dKstr
        ...
        L2 = "100e1" ;
        PATH      = PATH2D + "K=" + Kstr + "/" + NNstr + "/Cv=" + Cvstr + "/Knl=" + L2 + "/dKst=" + dKstr
        ...
        L3 = "100e2" ;
        PATH      = PATH2D + "K=" + Kstr + "/" + NNstr + "/Cv=" + Cvstr + "/Knl=" + L3 + "/dKst=" + dKstr
        ...
        L4 = "100e3" ;
        PATH      = PATH2D + "K=" + Kstr + "/" + NNstr + "/Cv=" + Cvstr + "/Knl=" + L4 + "/dKst=" + dKstr
        ...
        yLabel = pLabel
        lLabel      = [r"$Exp$", str(L1), str(L2), str(L3), str(L4)]
        ...
        lFileSep    = [",",",",",",",",","]
        lFile       = [Exp1,Data1,Data2,Data3,Data4]
