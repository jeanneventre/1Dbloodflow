...
def main(argv) :
    ...
    #############################
    try :
        opts, args = getopt.getopt(argv,"hp:l:s:y:c:r:j:o:t:d:k:n:v:i:",["path=","logo=","Solver","HR","drCoarse=","drFine=","Nx=","xOrder=","dt=","tOrder=","K=","NN=","Cv=","Knl="])
    except getopt.GetoptError:
          print ('writeParameter-55.py -p <PATH> -l <logo> -s <Solver> -y <HR> -c <drCoarse> -r <drFine> -j <Nx> -o <xOrder> -t <dt> -d <tOrder> -k <K> -n <NN> -v <Cv> -i <Knl>')
          sys.exit(2)
    for opt, arg in opts:
        if opt == '-h':
            print ('writeParameter-55.py -p <PATH> -l <logo> -s <Solver> -y <HR> -c <drCoarse> -r <drFine> -j <Nx> -o <xOrder> -t <dt> -d <tOrder> -k <K> -n <NN> -v <Cv> -i <Knl>')
    ...
    for i in range(NbrArt):
        ...
        # L_measpt_Profile = [20., 40., 60., 80., 100.,
        #                     120., 140., 160., 180., 200.,
        #                     220., 240., 260., 280., 300.,
        #                     320., 340., 360., 380., 400.,
        #                     420., 440., 460.];

        L_measpt_Profile = [28., 235., 252.];
    ...
    # Store Profile
    dt_storeProfile = 1.e-3 * (t_end-t_start)
