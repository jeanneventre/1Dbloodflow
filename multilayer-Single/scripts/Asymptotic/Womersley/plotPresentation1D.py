    ...
    for Womstr in ["5" , "20"] :
        ...
        for pType in ["Tw"] :
            ...
            for Nr in ["4","16","64"] :
                ...
                title = "Presentation_" + pType + "_Wom_"+str(Womstr) + "_Analytic.pdf"
                ...
                title = "Presentation_" + pType + "_Wom_"+str(Womstr) + "_2D_Nx_" + str(Nx) + "_Nr_" + str(Nr) + ".pdf"
                ...
                LegCol      = 1
                liY         = [ 1,iY1D,iY1D ]
                lYScale     = [ 1.,iYScale1D,iYScale1D ]
                lCol        = [ "red","seagreen","purple" ]
                lStyle      = [ "-","-.",":" ]
                lFile       = [ ANA ,Wom1_1D,Wom3_1D ]

                lLabel      = [
                                "Analytic","1D " + r"$C_f$=$8\pi\nu$", "1D " + r"$C_f$=$42\pi\nu$"
                                ]

                lText       = [r"$\alpha$="+str(Womstr),r"$N_x$=" + str(Nx)]

                title = "Presentation_" + pType + "_Wom_"+str(Womstr) + "_1D_Cf_8_42_Nx_" + str(Nx) + ".pdf"
                ...
                ###########################################################
                # Comparison with 1D & 2D
                ###########################################################

                LegCol      = 2
                liY         = [ 1,iY ,iY1D,iY1D]
                lYScale     = [ 1.,1. ,iYScale1D,iYScale1D]
                lCol        = [ "red","blue","seagreen","purple" ]
                lStyle      = [ "-","--","-.",":" ]
                lFile       = [ ANA,Wom,Wom1_1D,Wom3_1D ]

                lLabel      = [
                                "Analytic","2D","1D " + r"$C_f$=$8\pi\nu$", "1D " + r"$C_f$=$42\pi\nu$"
                                ]

                lText       = [r"$\alpha$="+str(Womstr),r"$N_x$=" + str(Nx) + r" $\rvert$ $N_r$=" + str(Nr)]

                title       = "Presentation_" + pType + "_Wom_"+str(Womstr) + "_2D_1D_Cf_8_42_Nx_" + str(Nx) + "_Nr_" + str(Nr) + ".pdf"
                ...
                #
                # lFile       = [
                #                 ANA,Wom,Wom1_1D,Wom3_1D
                #                 ]
                #
                # lLabel      = [
                #                 "Analytic","Multiring","1D, " + r"$C_f$ = $8\pi\nu$", "1D, " + r"$C_f$ = $42\pi\nu$"
                #                 ]
                #
                # lText       = [r"$\alpha$="+str(Womstr),r"$N_x$=" + str(Nx) + r" $\rvert$ $N_r$=" + str(Nr)]
                #
                # title = "Presentation_" + pType + "_Wom_"+str(Womstr) + "_2D_1D_Cf_8_42_" + str(Nx) + "_Nr_" + str(Nr) + ".pdf"
                #
                # nfig = plot_csv(    pathStore=Store,title=title,lFile=lFile,lFileSep=lFileSep,
                #                     liX=liX,liY=liY,
                #                     xLabel=xLabel,yLabel=yLabel,lLabel=lLabel,LabelSize=LabelSize,
                ...
                # ###########################################################
                # # Comparison with 1D and 2D, Cf=8pinu
                # ###########################################################
                #
                # lFile       = [
                #                 ANA ,Wom, Wom1_1D
                ...
                # lText       = [r"$\alpha$="+str(Womstr),r"$N_x$=" + str(Nx) + r" $\rvert$ $N_r$=" + str(Nr)]
                #
                # title = "Presentation_" + pType + "_Wom_"+str(Womstr) + "_1D_Cf_8_" + str(Nx) + "_Nr_" + str(Nr) + ".pdf"
                #
                # nfig = plot_csv(    pathStore=Store,title=title,lFile=lFile,lFileSep=lFileSep,
                #                     liX=liX,liY=liY,
                #                     xLabel=xLabel,yLabel=yLabel,lLabel=lLabel,LabelSize=LabelSize,
                ...
                #
                # ###########################################################
                # # Comparison with 1D and 2D, Cf=42pinu
                # ###########################################################
                #
                # lFile       = [
                #                 ANA ,Wom, Wom3_1D
                ...
                #
                # lLabel      = [
                #                 "Analytic","Multiring","1D, " + r"$C_f$ = $42\pi\nu$"
                #                 ]
                #
                # lText       = [r"$\alpha$="+str(Womstr),r"$N_x$=" + str(Nx) + r" $\rvert$ $N_r$=" + str(Nr)]
                #
                # title = "Presentation_" + pType + "_Wom_"+str(Womstr) + "_1D_Cf_42_" + str(Nx) + "_Nr_" + str(Nr) + ".pdf"
                #
                # nfig = plot_csv(    pathStore=Store,title=title,lFile=lFile,lFileSep=lFileSep,
                #                     liX=liX,liY=liY,
                #                     xLabel=xLabel,yLabel=yLabel,lLabel=lLabel,LabelSize=LabelSize,
