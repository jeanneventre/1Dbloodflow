...
def main(argv) :
    ...
    #############################
    try :
        opts, args = getopt.getopt(argv,"hp:l:s:y:c:r:j:o:k:u:e:d:",["path=","logo=","Solver","HR","Layer=","Raffinement=","Cells=","Order=","K=","U=","Re=","Length="])
    except getopt.GetoptError:
          print ('writeParameter-55.py -p <PATH> -l <logo> -s <Solver> -y <HR> -c <Layer> -r <Raf> -j <Cells> -o <Order> -k <K> -u <U> -e <Re> -d <Length>')
          sys.exit(2)
    for opt, arg in opts:
        if opt == '-h':
            print ('writeParameter-55.py -p <PATH> -l <logo> -s <Solver> -y <HR> -c <Layer> -r <Raf> -j <Cells> -o <Order> -k <K> -u <U> -e <Re> -d <Length>')
    ...
    mu  = U_c * R_c * rho / Re_c # Dynamic viscosity (g/cm/s)
