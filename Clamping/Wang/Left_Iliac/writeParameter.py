...
def main(argv) :
    ...
    arts[43].RtDAG( hConj=42,   Rt=1.,  tConj=hd.CONJ,nt=timeSteps)
    #----Not connected
    ...
    arts[45].iDAG(  hConj=56,       dArts=[arts[47],arts[48]],
                    xType="inQ",    xData=np.zeros(timeSteps),
                    FData=F_Input,  HData=H_Input,          tConj=hd.CONJ,nt=timeSteps)
    arts[46].RtDAG( hConj=56,   Rt=0.885,                   tConj=hd.CONJ,nt=timeSteps)
