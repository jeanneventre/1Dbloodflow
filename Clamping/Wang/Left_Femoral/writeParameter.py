...
def main(argv) :
	...
	# arts[45].RtDAG(  hConj=44,   Rt=1.,                     tConj=hd.CONJ,nt=timeSteps)
    arts[45].RtDAG( hConj=44,   Rt=1.,  tConj=hd.CONJ,nt=timeSteps)

    arts[44].RtDAG( hConj=42,   Rt=0.925,                   tConj=hd.CONJ,nt=timeSteps)
    arts[46].RtDAG( hConj=44,   Rt=0.885,                   tConj=hd.CONJ,nt=timeSteps)
    arts[47].RtDAG( hConj=56,   Rt=0.724,                   tConj=hd.CONJ,nt=timeSteps)
    arts[48].RtDAG( hConj=56,   Rt=0.716,                   tConj=hd.CONJ,nt=timeSteps)
