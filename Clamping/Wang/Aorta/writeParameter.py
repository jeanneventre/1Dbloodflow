...
def main(argv) :
    ...
    arts[36].RtDAG( hConj=35,   Rt=1.,                      tConj=hd.CONJ,nt=timeSteps)
    #----Not connected
    # arts[38].jDAG(  hConj=37,   dArts=[arts[39],arts[40]],  tConj=hd.CONJ,nt=timeSteps)
    arts[38].iDAG(  hConj=56,       dArts=[arts[39],arts[40]],
    ...
    arts[37].RtDAG( hConj=56,   Rt=0.861,                   tConj=hd.CONJ,nt=timeSteps)
