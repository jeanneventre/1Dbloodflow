...
def main(argv) :
    ...
    arts[51].RtDAG(  hConj=50,   Rt=1.,  tConj=hd.CONJ,nt=timeSteps)
    ...
    arts[53].RtDAG( hConj=56,   Rt=0.724,                   tConj=hd.CONJ,nt=timeSteps)
    arts[54].RtDAG( hConj=56,   Rt=0.716,                   tConj=hd.CONJ,nt=timeSteps)
