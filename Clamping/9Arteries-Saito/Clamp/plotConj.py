...
def main(argv) :
    ...
    for pType in ["U","P"] :
        ...
        ###########
        ArtName     = "Artery_3_t_"
        PATHSTART   = "/Rt=" + Rtstr + "/E=" + Estr + "/phi=" + phistr + "/Cv=" + Cvstr
        PATHEND     = "/xOrder=" + xOrderstr + "/dt=" + dtstr + "/tOrder=" + tOrderstr + "/" + Solverstr + "/" + HRstr + "/Figures/" + ArtName + pName

        J1   = "5"
        jS_1 = PATH + "/jS" + PATHSTART + "/Nx=" + J1 + PATHEND
        jA_1 = PATH + "/jA" + PATHSTART + "/Nx=" + J1 + PATHEND

        J2   = "7"
        jS_2 = PATH + "/jS" + PATHSTART + "/Nx=" + J2 + PATHEND
        jA_2 = PATH + "/jA" + PATHSTART + "/Nx=" + J2 + PATHEND

        J3   = "10"
        jS_3 = PATH + "/jS" + PATHSTART + "/Nx=" + J3 + PATHEND
        jA_3 = PATH + "/jA" + PATHSTART + "/Nx=" + J3 + PATHEND
        ...
        lXScale     = [1.,1.,
                       1.,1.,1.]
        lYScale     = [YScale,Y1DScale,
                       Y1DScale,Y1DScale,Y1DScale]
