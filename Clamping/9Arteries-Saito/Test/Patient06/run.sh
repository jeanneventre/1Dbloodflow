...
# LINUX
export folderGeneral=/Documents/Boulot/Thèse/code/bloodflow/bloodflow/Examples/Clamping/9Arteries-Saito/Test/Patient06
# MAC
                      ...
                      for tOrder in 2 ; do
                        for solver in "KIN_HAT"; do
                          for HR in HRQ; do
                            ...
                            export folderHR=${folderGeneral}/${NN}/${conj}/nuv=${nuv}/R1=${R1}/R2=${R2}/C=${C}/Nx=${Nx}/xOrder=${xOrder}/dt=${dt}/tOrder=${tOrder}/${solver}/${HR}
